...
Rel(ms_checkout, ms_pagamento, "HTTP/REST — solicita processamento de pagamento (síncrono)")
...
Rel(queue, ms_pagamento, "Consume eventos (processar pagamento assíncrono)")
